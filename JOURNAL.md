...
1:02-1:54pm - I designed my case on fusion 360. I made a seperate case body and lid so that it would be easy to fit the PCB inside.

6:45-8:12 - I read multiple tutorials on using qmk and vsc to create firmware for the macropad. I then downloaded qmk, and wrote the firmware for my project.

8:15-9:36 - I imported models of all the non-3d printed parts i would use for my project into fusion 360, and assembled them all together.
